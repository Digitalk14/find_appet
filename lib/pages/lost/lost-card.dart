        ...
        child: Center(
          child: Column(
            children: [
              ...
              Row(
                children: [
                  LostCardTextBlock(text: 'Breed', subtitle: 'Retriever ',),
                  LostCardTextBlock(text: 'Color', subtitle: 'Gold',),
                ],
              ),
              SizedBox(height: 30,),
              Row(
                children: [
                  LostCardTextBlock(text: 'Size', subtitle: 'Medium',),
                  LostCardTextBlock(text: 'Date found', subtitle: '27 june 2022',),
                ],
              ),
            ],
          ),
